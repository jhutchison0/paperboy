...
10. [.claude/skills/lake-conventions/HOME-STORAGE.md](.claude/skills/lake-conventions/HOME-STORAGE.md) — where bulk data goes if paperboy ever writes any (scope: personal, home storage, no address in git).
